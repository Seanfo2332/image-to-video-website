      ...
      >
        ...
        <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
          <label className="block text-white font-medium mb-4 flex items-center gap-2">
            ...
            Portrait Image <span className="text-red-400">*</span>
          </label>
          <div className="relative">
            ...
            <label
              ...
              className="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-white/20 rounded-xl cursor-pointer hover:border-cyan-500/50 transition-colors"
            >
              {imagePreview ? (
                <img
                  src={imagePreview}
                ...
                <>
                  ...
                  <p className="text-neutral-400 text-lg">Click to upload portrait</p>
                  <p className="text-neutral-500 text-sm mt-1">JPEG, PNG (face clearly visible)</p>
                </>
              )}
            </label>
          </div>
        ...
        <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
          <label className="block text-white font-medium mb-4 flex items-center gap-2">
            ...
            Script / Video Content <span className="text-red-400">*</span>
          </label>
          <textarea
            ...
            rows={8}
            className="w-full px-4 py-4 rounded-xl bg-white/5 border border-white/10 text-white placeholder-neutral-500 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50 transition-all resize-none text-base leading-relaxed"
          />
        ...
        <motion.button
          ...
          className="w-full py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-medium shadow-lg shadow-cyan-500/25 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isSubmitting ? (
            <>
